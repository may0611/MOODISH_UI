...
const SurveyScreenSad = ({ navigation }) => {
  ...
  const handleNext = () => {
    ...
    navigation.navigate('KitchenUtensils'); // 다음 화면으로 이동
  };
  ...
  return (
    <View style={styles.container}>
      {/* 질문 텍스트 */}
      <Text style={styles.questionText}>홍길동님은 <Text style={styles.highlight}>슬플</Text> 때 주로{'\n'} 어떤 음식을 먹나요?</Text>
...
export default SurveyScreenSad;
