...
const SurveyScreenAngry = ({ navigation }) => {
  ...
  const handleNext = () => {
    ...
    navigation.navigate('SurveyScreenSad'); // 다음 화면으로 이동
  };
  ...
  return (
    <View style={styles.container}>
      {/* 질문 텍스트 */}
      <Text style={styles.questionText}>홍길동님은 <Text style={styles.highlight}>화나거나 스트레스 받을</Text> 때{'\n'}  주로 어떤 음식을 먹나요?</Text>
...
export default SurveyScreenAngry;
